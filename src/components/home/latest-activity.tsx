...
const DashboardLatestActivityies = () => {
    ...
    return (
        <Card
            ...
            title={
                <div
                    style={{ display: 'felx', alignItems: 'center', gap: '8px' }}
                >
                                ...
                                <List.Item.Meta
                                    ...
                                    description={
                                        <Space size={4}>
                                            ...
                                            <Text style={{ opacity: .9 }} >{item.action === 'CREATE' ? 'created' : 'moved'}</Text>
                                            <Text strong>{deal?.title}</Text>
                                            <Text style={{ opacity: .9 }}>deal</Text>
                                            <Text style={{ opacity: .9 }}>{item.action === 'CREATE' ? 'in' : 'to'}</Text>
...
export default DashboardLatestActivityies